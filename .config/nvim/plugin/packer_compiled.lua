...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp_luasnip", "cmp-cmdline", "cmp-nvim-lsp", "cmp-fuzzy-path", "LuaSnip", "cmp-skkeleton" },
  ...
  ["nvim-treesitter"] = {
    ...
    config = { "\27LJ\2\n#\0\1\3\0\1\0\0039\1\0\0B\1\1\1K\0\1\0\20treesitterSetup;\1\0\4\0\3\0\0056\0\0\0'\2\1\0003\3\2\0B\0\3\1K\0\1\0\0\28alliana.treesitter-conf\vimport\0" },
    load_after = {
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-cmp', 'indent-blankline.nvim', 'staline.nvim', 'nvim-ts-context-commentstring', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
